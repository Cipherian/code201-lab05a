...
function sum(a, b) {
  ...
  //This one was already fixed when I downloaded it, just adding a comment to verify that I looked at it.
}
...
its single argument and then returns an array where the first element is the sum of the 
numbers in the array, and the second element is a string that EXACTLY follows this example 
